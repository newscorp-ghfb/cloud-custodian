...
class StorageAccountUnit(DeploymentUnit):
    def __init__(self):
        super(StorageAccountUnit, self).__init__('azure.mgmt.storage.StorageManagementClient')
        self.type = "Storage Account"

    def _get(self, params):
        try:
            return self.client.storage_accounts.get_properties(
    ...
    def _provision(self, params):
        ...
        return self.client.storage_accounts.begin_create(
            params['resource_group_name'], params['name'], sa_params
        ).result()
