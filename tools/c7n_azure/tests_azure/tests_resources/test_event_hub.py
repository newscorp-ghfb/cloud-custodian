...
class EventHubTest(BaseTest):
    def test_event_hub_schema_validate(self):
        with self.sign_out_patch():
            p = self.load_policy(
                {'name': 'test-event-hub-compliance', 'resource': 'azure.eventhub'}, validate=True
            )
            self.assertTrue(p)
        ...
        p = self.load_policy(
            {
                ...
                'filters': [
                    ...
                    {'type': 'firewall-rules', 'include': ['11.0.0.0/24']},
                ],
            }
        )
        resources = p.run()
        ...
        p = self.load_policy(
            {
                ...
                'filters': [
                    ...
                    {'type': 'firewall-rules', 'include': ['11.0.1.0/24']},
                ],
            }
        )
        resources = p.run()
        ...
        p = self.load_policy(
            {
                ...
                'filters': [
                    ...
                    {'type': 'firewall-rules', 'include': ['11.0.0.0-11.0.0.255']},
                ],
            },
            validate=True,
        )
        ...
        p = self.load_policy(
            {
                ...
                'filters': [
                    ...
                    {'type': 'firewall-rules', 'include': ['11.0.1.0-11.0.1.255']},
                ],
            },
            validate=True,
        )
        ...
        p = self.load_policy(
            {
                ...
                'filters': [
                    ...
                    {'type': 'firewall-rules', 'equal': ['11.0.0.0/24', '10.1.1.1/32']},
                ],
            },
            validate=True,
        )
        ...
        p = self.load_policy(
            {
                ...
                'filters': [
                    ...
                    {'type': 'firewall-rules', 'equal': ['11.0.1.0/24', '10.1.1.1/32']},
                ],
            },
            validate=True,
        )
