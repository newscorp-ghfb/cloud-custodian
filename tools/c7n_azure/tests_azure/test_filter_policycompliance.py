...
class PolicyCompliance(BaseTest):
            ...
            p = self.load_policy(
                {
                    ...
                    'resource': 'azure.vm',
                    'filters': [{'type': 'policy-compliant', 'compliant': True}],
                },
                validate=True,
            )
            self.assertTrue(p)
    ...
    @patch(
        "azure.mgmt.policyinsights.operations.PolicyStatesOperations."
        ...
        p = self.load_policy(
            {
                ...
                'filters': [
                    ...
                    {'type': 'policy-compliant', 'compliant': True},
                ],
            }
        )
        resources = p.run()
        ...
        p = self.load_policy(
            {
                ...
                'filters': [
                    ...
                    {'type': 'policy-compliant', 'compliant': False},
                ],
            }
        )
        resources = p.run()
        ...
        p = self.load_policy(
            {
                ...
                'filters': [
                    ...
                    {'type': 'policy-compliant', 'definitions': ['TEST'], 'compliant': True},
                ],
            }
        )
        resources = p.run()
        ...
        p = self.load_policy(
            {
                ...
                'filters': [
                    ...
                    {'type': 'policy-compliant', 'definitions': ['TEST'], 'compliant': False},
                ],
            }
        )
        resources = p.run()
