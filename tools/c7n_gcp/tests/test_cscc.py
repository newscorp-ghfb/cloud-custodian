...
class PostFinding(BaseTest):
    def test_cscc_post(self):
        ...
        p = self.load_policy(
            {
                ...
                'actions': [{'type': 'post-finding', 'org-domain': 'example.io'}],
            },
        ...
        results = findings.execute_query('list', {'parent': source}).get('findings', [])
...
class NameResolver(BaseTest):
    def assertName(self, service, src, expected):
        self.assertEqual(ResourceNameAdapters[service](src), expected)
    ...
    def test_gke_cluster_naem(self):
        self.assertName(
            "container",
            {
                'selfLink': 'https://container.googleapis.com/v1/projects/test-226520/zones/us-central1-a/clusters/dev-cluster'
            },  # noqa
            "//container.googleapis.com/projects/test-226520/zones/us-central1-a/clusters/dev-cluster",
        )  # noqa
    ...
    def test_appengine_name(self):
        self.assertName(
            "appengine", {'name': 'apps/test-226520'}, "//appengine.googleapis.com/apps/test-226520"
        )
    ...
    def test_compute_name(self):
        self.assertName(
            "compute",
            {
                ...
                'selfLink': 'https://www.googleapis.com/compute/v1/projects/test-226520/zones/us-east1-b/instances/instance-1',
            },  # noqa
            "//compute.googleapis.com/projects/test-226520/zones/us-east1-b/instances/3933994916372270321",
        )  # noqa

    def test_bucket_name(self):
        self.assertName(
            "storage", {'name': 'c7n-org-devtest'}, "//storage.googleapis.com/c7n-org-devtest"
        )
