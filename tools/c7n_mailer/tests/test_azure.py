...
class AzureTest(unittest.TestCase):
    ...
    def test_process_azure_queue_message_success(self, mock_get_addr, mock_handler):
        ...
        self.assertTrue(
            azure_processor.process_azure_queue_message(self.compressed_message)
        )
    ...
    def test_slack_delivery(self, mock_slack):
        ...
        self.assertTrue(
            azure_processor.process_azure_queue_message(slack_compressed_message)
        )
    ...
    def test_datadog_delivery(self, mock_datadog):
        ...
        self.assertTrue(
            azure_processor.process_azure_queue_message(datadog_compressed_message)
        )
